...
namespace TimeoutMigrationTool.Msmq.AcceptanceTests
{
    ...
    public class MigrationRunner
    {
        public static void Run(string connectionString)
        {
            ...
            var args = $@"exec {exePath} migrate --allEndpoints sqlp  --source ""{connectionString}"" --dialect MsSqlServer msmq --target ""{connectionString}"" --fx-version {Environment.Version}";
