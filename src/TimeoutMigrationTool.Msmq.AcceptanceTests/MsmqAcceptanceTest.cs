namespace TimeoutMigrationTool.Msmq.AcceptanceTests
{
    ...
    [TestFixture]
    public abstract class MsmqAcceptanceTest
    {
        [SetUp]
        public async Task SetUp()
        {
            ...
            connectionString = $@"Data Source=192.168.0.114;Initial Catalog={databaseName};User Id=sa;Password=GQI1qNeq0oEHlL;";
        ...
        {
            return QueryScalar<int>($"SELECT COUNT(*) FROM [{endpointName}.Timeouts]");
        }
