namespace TimeoutMigrationTool.SqlP.AcceptanceTests
{
    ...
    [TestFixture]
    class SqlPToMsmqSqlEndToEnd : SqlPAcceptanceTest
    {
        [SetUp]
        public void Setup()
        {
        ...
        public async Task Can_migrate_timeouts()
        {
            ...
            var targetEndpoint = NServiceBus.AcceptanceTesting.Customization.Conventions.EndpointNamingConvention(typeof(MsmqSqlTarget));
            ...
            var context = await Scenario.Define<TargetContext>()
                .WithEndpoint<MsmqSqlTarget>(b => b.CustomConfig(ec =>
                {
                    ec.UseTransport<Msmq>()
        ...
        public class MsmqSqlTarget : EndpointConfigurationBuilder
        {
            public MsmqSqlTarget()
            {
